-- KUCCPS COURSE FINDER - PostgreSQL Schema
-- =====================================================

-- USERS TABLE (VARCHAR IDs)
...
-- TRANSACTIONS TABLE (with VARCHAR user_id)
...
-- GRADES TABLE (with VARCHAR user_id)
...
-- RESULTS TABLE (with VARCHAR user_id)
